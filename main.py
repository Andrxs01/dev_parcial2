...
@app.get("/usuarios/premium/activos", response_model=List[Usuario], summary="Listar usuarios premium activos")
...
@app.get("/tareas/", response_model=List[Tarea], summary="Listar todas las tareas")
...
@app.get("/tareas/usuario/{usuario_id}", response_model=List[Tarea], summary="Listar tareas de un usuario")
